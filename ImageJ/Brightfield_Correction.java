...
public class Brightfield_Correction implements PlugIn {

    static String title = "Brightfield correction";
    ...
    public void calculate(ImagePlus i1,ImagePlus i2, ImagePlus i3, double k1, double k2) {
        double v1, v2=0, v3, r1, g1, b1, r2, g2, b2, r3, g3, b3, numr, numg, numb, divr, divg, divb;
		int iv1, iv2, iv3, r, g=0, b=0; 
